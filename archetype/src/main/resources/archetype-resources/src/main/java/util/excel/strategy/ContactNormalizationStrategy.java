...
/**
 * Strategia di normalizzazione per contatti CRM.
 * Normalizza telefoni, email, nomi, cognomi secondo le regole del dominio.
 */
public class ContactNormalizationStrategy implements NormalizationStrategy {
     ...
     * - Converte numeri (double/float) in stringhe senza decimali
