...
public class DateTime
{
   ...
   *
   * @param date
   *          Stringa data (es: "2025-11-01")
   * @return LocalDate parsato
   * @throws Exception
   *           Se la stringa non è una data valida
   */
   ...
   *
   * @param time
   *          Stringa tempo (es: "14:30:00")
   * @return LocalTime parsato
   * @throws Exception
   *           Se la stringa non è un tempo valido
   */
   ...
   *
   * @param dateTime
   *          Stringa data/tempo (es: "2025-11-01T14:30:00")
   * @return LocalDateTime parsato
   * @throws Exception
   *           Se la stringa non è un datetime valido
   */
   ...
   *          Stringa data/tempo
   * @param format
   *          Pattern formato (es: "dd/MM/yyyy HH:mm")
   * @return LocalDateTime parsato
   * @throws Exception
   *           Se la stringa non è un datetime valido
   */
   ...
   *          LocalDate base
   * @param days
   *          Numero di giorni da aggiungere (può essere negativo)
   ...
   *          LocalDate base
   * @param months
   *          Numero di mesi da aggiungere (può essere negativo)
   * @return LocalDate risultante
   */
   ...
   *          LocalDate base
   * @param years
   *          Numero di anni da aggiungere (può essere negativo)
   * @return LocalDate risultante
   */
