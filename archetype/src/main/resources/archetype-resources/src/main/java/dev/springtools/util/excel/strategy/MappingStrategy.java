...
/**
 * Strategia per il mapping delle intestazioni Excel verso i campi logici dell'applicazione.
 * Può essere implementata in modo statico (dizionario) o dinamico (ML, fuzzy matching, ecc.).
 */
@FunctionalInterface
public interface MappingStrategy {
     ...
     * @param excelHeader nome colonna Excel
