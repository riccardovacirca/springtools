 ...
 *
 * <p>
 * Formato standard: {"err": boolean, "log": string|null, "out": object|null}
 *
 * <p>
...
public class HttpResponse
{
   ...
   *
   * @param value
   *          true se errore, false altrimenti
   ...
   *
   * @param message
   *          Messaggio (null se nessun messaggio)
   * @return this per chaining
   */
   ...
   *
   * @param data
   *          Dati da restituire (null se nessun dato)
   * @return this per chaining
   */
   ...
   *
   * <p>
   * Spring serializza automaticamente in base al Content-Type impostato (default:
   * application/json).
   *
