...
/**
 * Strategia per normalizzare i valori di un record Excel.
 * Può implementare trasformazioni comuni: trim, lowercase, parsing date, ecc.
 */
@FunctionalInterface
public interface NormalizationStrategy {
     ...
     * @param row record raw (chiavi già mappate)
